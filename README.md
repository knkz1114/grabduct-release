...
| コンポーネント | バージョン |
|---------------|-----------|
| Chrome拡張機能 | https://github.com/knkz1114/grabduct-release/releases/tag/extension-v0.3.6 |
| レシーバーアプリ | https://github.com/knkz1114/grabduct-release/releases/tag/receiver-v0.3.3 |
